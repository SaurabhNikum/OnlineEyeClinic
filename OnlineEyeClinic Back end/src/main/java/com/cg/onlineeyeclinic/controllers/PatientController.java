...
public class PatientController 
{
	...
	@GetMapping("/patient/byname/{name}")
	...
	@GetMapping("/patient/byusername/{name}")
	public ResponseEntity<String> getPatientIdByUserame(@PathVariable String name) throws NameNotFoundException
	{
		int id=patientService.getPatientByUserName(name).getPatientId();
