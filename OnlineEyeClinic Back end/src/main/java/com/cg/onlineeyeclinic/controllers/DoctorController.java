...
public class DoctorController 
{
	...
	@GetMapping("/doctor/byusername/{name}")
	public ResponseEntity<String> getDoctorIdByUsername(@PathVariable String name)throws NameNotFoundException
	{
		int id=doctorService.getDoctorIdByUsername(name);
